...
module.exports = function(req,res,next){
    ...
    &&"information_user"
    &&"information_place"
    &&"information_latitude"
    &&"information_longitude"
    &&"information_endmouthtime"
    &&"information_endtime"
    &&"information_phone"
    &&"information_town"
    &&"information_detaiLocation"
    &&"information_limitSex" in req.body){//判断是否接收到指定的参数
        let myDate = new Date();
        ...
        let s = myDate.getSeconds();//获取当前秒钟数(0-59)
